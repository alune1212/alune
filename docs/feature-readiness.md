...
This document is a feature-readiness check for Alune Hub. It does not introduce approval flows, reports, payroll, employee business modules, executable scripts, task scheduling, dynamic plugin loading, or other company-specific workflows.
