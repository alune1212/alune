...
- Continue migrating mutation-heavy internal system page actions from compatibility functions to `@alune/api-client/generated`, starting with JSON writes before binary download/export boundaries.
