...
- Stage 6C internal system foundation with user create/enable/disable, user role assignment, role permission assignment, department tree/update/delete rules, audit log views, dictionary management, local file upload/download, and search/pagination for key management lists.
...
- Keep stage 0-6C minimal. Avoid over-abstracting before real business modules exist.
